...
public class PhaseOneFightingPokemon extends AbstractFightingPokemon implements IPhaseOnePokemon {
     ...
     */
    public PhaseOneFightingPokemon(String name, int hp, int id, EnergyCost countEnergy, List<IAbility> attackList, int basicPokemonIDPreEv) {

...
/**
 * Create Phase One Grass Pokemon
 *
 * @author cmesiasd
 * @version 2.0
 */
public class PhaseOneGrassPokemon extends AbstractGrassPokemon implements IPhaseOnePokemon {
     ...
     */
    public PhaseOneGrassPokemon(String name, int hp, int id, EnergyCost countEnergy, List<IAbility> attackList, int basicPokemonIDPreEv) {

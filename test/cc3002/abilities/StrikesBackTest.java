...
public class StrikesBackTest {
    ...
    private StrikesBack strikesBack = new StrikesBack();
    ...
    public void setUp() throws Exception {
        ...
        LA_Pokemon3.add(strikesBack);
        LA_Pokemon3.add(attack2);
        ...
        basicWaterPokemon = new BasicWaterPokemon("Squirtle", 65,14,FullEnergy,LA_Pokemon3);
        //endregion
    }
    ...
    public void play() {
        ...
        trainer1.play(basicWaterPokemon);
        trainer1.setSelectedPokemon(basicWaterPokemon);

        trainer2.play(basicGrassPokemon);
        assertEquals(trainer1.getActivePokemon().getHP(),65);
        assertEquals(trainer2.getActivePokemon().getHP(),70);

        trainer2.attackTrainer(trainer1,0);

        assertEquals(trainer1.getActivePokemon().getHP(),5);
        assertEquals(trainer2.getActivePokemon().getHP(),70);
    }
